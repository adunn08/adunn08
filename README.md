...
- **Open source for Claude.** Skills, MCP integrations, and reusable workflows. New repos ship under [@rampstackco](https://github.com/rampstackco).
- **SEO.** On-page, technical, content, AEO/GEO, and audit playbooks. The `seo-*` skills in claude-skills are the codified version.
- **Growth and brand systems.** Strategy, identity, design tokens, and the messy middle between an idea and a shipped product.
